import Navbar from '@/app/(serveces)/Componint/Navbar';
import React from 'react'
export const metadata ={
  title: "Color"
}
async function page({searchParams}:{searchParams:Promise<{lang?:string}>}) {
    const {lang = "en"} = await searchParams;
    if(lang === "en"){
  return (
   <div>
    <Navbar/>
      <div className="w-full h-[550px] object-cover flex py-23 justify-center flex-col items-center rounded-md bg-blue-200">
